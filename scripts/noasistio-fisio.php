...
<body>
    ...
    if($pass)
    {
        ...
        <div>
          <p style='margin-left:13px; font-size: 20px;'>Se ha actualizado correctamente
        </div>
      </div>
      ";  
      header('refresh:2 ../views/fisioterapeuta/citas_hoy.php');
    ...
    else
    {
        ...
        <div>
        <p style='margin-left:13px; font-size: 20px;'> No se ha podido actualizar </p>
        </div>
      </div>
      "; 
      header('refresh:2 ../views/fisioterapeuta/citas_hoy.php');
