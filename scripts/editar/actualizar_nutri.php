...
{
  echo"<div class='alert alert-success d-flex justify-content-center' role='alert' style='margin-top:1px'; >
  <svg class='bi flex-shrink-0 me-2' width='30' height='30' role='img' aria-label='Success:'><use xlink:href='#check-circle-fill'/></svg>
  <div>
    <p style='margin-left:13px; font-size: 20px;'>Actualizacion de datos realizada con exito</p>
  </div>
</div>
...
{
  echo"<div class='alert alert-warning d-flex justify-content-center' role='alert'>
  ...
  <div>
  <p style='margin-left:13px; font-size: 20px;'> No se ha modificado ningun dato </p>
  </div>
</div>
